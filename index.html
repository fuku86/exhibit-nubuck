...
- スエード（裏面起毛）よりキメが細く、やや丈夫。詳しくは下の「特徴・お手入れ」へ。英語はページ下部にあります（EN）。
...
---
> 注記：このページは展示品の解説ページです。以下は会社の公式サイトへのリンクです。

- 企業サイト：ミドリオートレザー株式会社 https://midori-alg.com/
